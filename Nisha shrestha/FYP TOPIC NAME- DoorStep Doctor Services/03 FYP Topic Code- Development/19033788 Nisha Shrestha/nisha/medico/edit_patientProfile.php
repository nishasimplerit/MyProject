...
<html>
	...
	<body>
	  ...
	  //       mysqli_select_db("healthcare",$conn) or die("can not select database");
			...
			$query="select patient_fname, patient_lname, patient_sickness, patient_age, patient_birthdate, patient_gender, patient_height, patient_weight, patient_status, patient_address, patient_contactno from patient where patient_username='{$username}';";
